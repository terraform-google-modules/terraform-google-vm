...
| instance\_lifecycle\_policy | The instance lifecycle policy for this managed instance group. https://registry.terraform.io/providers/hashicorp/google-beta/latest/docs/resources/compute_region_instance_group_manager#nested_schema_for-instance_lifecycle_policy | <pre>object({<br>    default_action_on_failure = optional(string, "REPAIR")<br>    on_failed_health_check    = optional(string, "DEFAULT_ACTION")<br>    force_update_on_repair    = optional(string, "NO")<br>    on_repair = optional(object({<br>      allow_changing_zone = optional(string, "NO")<br>    }))<br>  })</pre> | `null` | no |
