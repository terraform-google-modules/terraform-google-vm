...
| autoscaling\_scale\_down | Autoscaling, scale down policy block as single element array. https://www.terraform.io/docs/providers/google/r/compute_autoscaler.html#scale_down_control | <pre>list(object({<br>    max_replicas_fixed   = number<br>    max_replicas_percent = number<br>    time_window_sec      = number<br>  }))</pre> | `[]` | no |
