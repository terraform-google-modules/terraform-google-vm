...
output "self_link" {
  ...
  value       = module.confidential_gpu.self_link
}

output "name" {
  description = "Name of the instance templates."
  value       = module.confidential_gpu.name
}

output "instance_self_link" {
  description = "Self-link for compute instance"
  value       = module.confidential_gpu.instance_self_link
}
...
output "suffix" {
  ...
  value       = module.confidential_gpu.suffix
}
